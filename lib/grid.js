  ...
  configureWalls() {
    ...
    this.cells.forEach( (row, i) => {
      ...
      row.forEach( (cell, j) => {
        ...
        // westmost wall
        top.push(Bodies.rectangle(0, (i + 1) * 32 + 17, 2, 31, { isStatic: true,
          render: {
        ...
        // northmost wall
        bottom.push(Bodies.rectangle(j * 32 + 18, 32, 31, 2, { isStatic: true,
          render: {
           fillStyle: randomColor(),
           strokeStyle: randomColor(),
           lineWidth: 2
        ...
        if (!cell.isLinked(cell.east)) {
          ...
          top.push(Bodies.rectangle((j + 1) * 32, (i + 1) * 32 + 17, 2, 31, { isStatic: true,
            render: {
             fillStyle: randomColor(),
             strokeStyle: randomColor(),
             lineWidth: 2
        ...
        if (!cell.isLinked(cell.south)) {
          ...
          bottom.push(Bodies.rectangle(j * 32  + 18, (i + 2) * 32, 31, 2, { isStatic: true,
            render: {
             fillStyle: randomColor(),
             strokeStyle: randomColor(),
             lineWidth: 2
